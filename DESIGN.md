...
1. 快速生成基础代码 - Express 路由、React 组件模板，减少重复劳动 <br>
2. SQL 语句生成 - 复杂多表联查的 SQL 编写，LLM 表现出色 <br>
3. 思路梳理 - 实现方案不确定时，AI 能提供多个可行方向 <br>

3.4 AI 帮不上忙的地方

1. 业务逻辑理解 - 基金行业的专业术语、业务规则需要人工确认 <br>
2. 异常边界处理 - AI 不了解生产环境的特殊情况（如数据库连接超时） <br>
3. 调试定位问题 - 线上 bug 仍需人工分析日志、定位根因 <br>
4. 安全性判断 - SQL 注入风险需要人工二次审核 <br>
